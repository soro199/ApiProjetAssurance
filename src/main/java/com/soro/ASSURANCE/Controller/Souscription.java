...
public class Souscription {
    ...
    @PostMapping("/ajoutSouscriptiono")
	
	public com.soro.ASSURANCE.Entity.Souscription AjouterUtilisateur(@RequestBody com.soro.ASSURANCE.Entity.Souscription ag) {
	...
	@ResponseBody
	@Transactional
	public com.soro.ASSURANCE.Entity.Souscription updateSouscription(@RequestBody com.soro.ASSURANCE.Entity.Souscription U, @PathVariable Long id) {
